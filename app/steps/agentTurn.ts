...
export async function agentTurn(args: {
  ...
  const connectToolkit = tool({
    description:
      "Generate a Composio connect/authorize link for a toolkit. You are connected to every composio tool/api like discord, instagram, google drive, gmail, typeform, etc. Accepts user-friendly names like 'Typeform', 'Google Drive', or 'X'. Resolves by listing available Composio toolkits and choosing the closest match slug.",
